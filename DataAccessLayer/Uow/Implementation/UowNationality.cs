...
namespace DataAccessLayer.Uow.Implementation
{
...

    {
      //  private readonly IConfiguration _configuration;
        ...
        public UowNationality(string connectionstring, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public UowNationality(IHttpContextAccessor httpContextAccessor) : this(
