...
namespace DataAccessLayer.Uow.Implementation
{
    public class UowForgotPassword: IUowForgotPassword
    {
        ...
        public UowForgotPassword(string connectionstring, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public UowForgotPassword(IHttpContextAccessor httpContextAccessor) : this(
